...
namespace SitioWebdeSUCARNET.Models
{
    public class Conexion
    {
        ...
        public int actualizarOferta(int idOferta, int nIdEmpresa, String sTituloOferta, int nTipoJornada, int nTipoContrato,double fSalario, int nIdLocalidad, int nTipoLocalidad, int nIdCategoria, String sDescripcion,
        String fechaContratacion, int nVacantes)
        {
            //Consulta Update SQL a tabla ofertas
            String queryUpdate = "update ofertas setnIdEmpresa = @p1,sTituloOferta = @p2,nTipoJornada = @p3,nTipoContrato = @p4,fSalario = @p5,nIdLocalidad = @p6,nTipoLocalidad = @p7, nIdCategoria = @p8, sDescripcion = @p9, fechaContratacion = @p10, nVacantes = @p11 where nIdOferta = " +idOferta;
            SqlCommand comando = new SqlCommand();
            comando.CommandType = System.Data.CommandType.Text;
